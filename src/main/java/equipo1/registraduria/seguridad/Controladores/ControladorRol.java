...
public class ControladorRol {
    ...
    public Rol create(@RequestBody Rol infoRol){
        System.out.println("Creando un Rol");
        return this.miRepositorioRol.save(infoRol);
    }
    @GetMapping("{id}")
    public Rol show(@PathVariable String id){
        System.out.println("Mostrando un Rol con id "+ id);
    ...
    public Rol update(@PathVariable String id, @RequestBody Rol infoRol){
        System.out.println("Modificando un Rol con id "+ id);
        Rol rolActual = this.miRepositorioRol
                .findById(id)
                .orElse(null);
        if(rolActual != null){
    ...
    public void delete(@PathVariable String id){
        System.out.println("Eliminando el Rol con id "+ id);
